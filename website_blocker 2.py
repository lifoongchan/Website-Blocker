...
block.place(x=200, y=150)

def Unblock():
    def Unblock():
        website_lists = Website.get(1.0,END)
        Website = list(website_lists.split(","))
...
unblock = Button(root, text='Unblock', font='arial 12 bold', pady=5, command=Blocker, width=6, bg='royal blue1', activebackground='sky blue')
